...
CLAUDE.md                   LE CONTRAT : les 5 tables gelées, qui écrit quoi
...
quoi** : voir le CONTRAT dans [CLAUDE.md](CLAUDE.md) — liste fermée, seul
Robin l'édite. Le graphe du front = les FK (`contacts.company_id`,
